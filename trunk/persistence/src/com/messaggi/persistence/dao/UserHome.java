 ...
 * @see com.messaggi.persistence.dao.User
...
public class UserHome
{
    ...
    public User findById(long id)
    {
        ...
        try {
            User instance = (User) sessionFactory.getCurrentSession().get("com.messaggi.persistence.dao.User", id);
            if (instance == null) {
    ...
    public List<User> findByExample(User instance)
    {
        ...
        try {
            List<User> results = sessionFactory.getCurrentSession()
                    .createCriteria("com.messaggi.persistence.dao.User").add(create(instance)).list();
