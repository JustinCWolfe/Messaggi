 ...
 * @see com.messaggi.persistence.dao.Application
...
public class ApplicationHome
{
    ...
    public Application findById(long id)
    {
        ...
        try {
            Application instance = (Application) sessionFactory.getCurrentSession().get(
                    "com.messaggi.persistence.dao.Application", id);
            if (instance == null) {
    ...
    public List<Application> findByExample(Application instance)
    {
        ...
        try {
            List<Application> results = sessionFactory.getCurrentSession()
                    .createCriteria("com.messaggi.persistence.dao.Application").add(create(instance)).list();
