...
public class TestThreadPool extends ThreadPoolTestCase<ThreadPool>
{
    ...
    public void testAddTask_MultipleThreads() throws Exception
    {
        ...
        PoolAddTaskCaller r4 = new PoolAddTaskCaller(pool, t4, false);
        PoolAddTaskCaller r5 = new PoolAddTaskCaller(pool, t5, false);
        PoolAddTaskCaller r6 = new PoolAddTaskCaller(pool, t6, false);
        PoolAddTaskCaller r7 = new PoolAddTaskCaller(pool, t7, false);
        PoolAddTaskCaller r8 = new PoolAddTaskCaller(pool, t8, false);
        PoolAddTaskCaller r9 = new PoolAddTaskCaller(pool, t9, false);
        PoolAddTaskCaller r10 = new PoolAddTaskCaller(pool, t10, false);
    ...
    public void testAddTaskInternal_AddToFront_MultipleThreads() throws Exception
    {
        ...
        PoolAddTaskCaller r4 = new PoolAddTaskCaller(pool, t4, true);
        PoolAddTaskCaller r5 = new PoolAddTaskCaller(pool, t5, true);
        PoolAddTaskCaller r6 = new PoolAddTaskCaller(pool, t6, true);
        PoolAddTaskCaller r7 = new PoolAddTaskCaller(pool, t7, true);
        PoolAddTaskCaller r8 = new PoolAddTaskCaller(pool, t8, true);
        PoolAddTaskCaller r9 = new PoolAddTaskCaller(pool, t9, true);
        PoolAddTaskCaller r10 = new PoolAddTaskCaller(pool, t10, true);
        List<Thread> testThreads1 = getTestThreads(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10);
        for (Thread t : testThreads1) {
            t.start();
            Thread.sleep(5);
